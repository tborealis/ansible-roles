...
Supported PHP versions: 7.4, 8.0, 8.1, 8.2, 8.3, 8.4, 8.5. The role asserts `php_cli_version` is one of these and fails otherwise.
...
| `php_cli_supported_versions` | `["7.4", "8.0", "8.1", "8.2", "8.3", "8.4", "8.5"]` | Versions this role can configure |
